% Created by tikzDevice version 0.12.3 on 2019-11-29 00:03:56
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (193.78,  7.64) {F3-F2 (Semitone)};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (361.35,289.08);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at ( 13.08,148.85) {F2-F1 (Semitone)};
\end{scope}
\end{tikzpicture}
